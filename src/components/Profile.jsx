...
function Profile()
{
    ...
    // Fetch user data from server after the component mounts
    useEffect(() => {
            ...
            <>
                 <section style={{maxwidth:'100%',margin:'0px',height:'fit-content',paddingLeft:"320px",paddingRight:"20px",paddingTop:"80px",
                    ...
                    <div >
                        ...
                        <h1 style={{color:'#111',fontSize:'60px',margin:'0px',fontFamily:'cursive',fontWeight:'bold',marginBottom:'8px'}}>Welocme to AuctionHub,</h1>
    
                        <h1 style={{color:'#d6482b',margin:'0px',fontSize:'60px',fontFamily:'cursive',marginBottom:'8px'}}>{userName}</h1>
                        
                        <div style={{display:'flex',gap:'16px',margin:'0px',marginTop:'32px',marginBottom:'32px'}}>
                            
                            <Link to='/buy' style={{color:'#DECCBE',transitionProperty:'all',transitionDuration:'300ms',animationDuration:'300ms',backgroundColor:'transparent',fontFamily:'cursive',border:'2px solid',borderColor:'#DECCBE',textDecoration:'none',fontWeight:'bold',padding:'20px',fontSize:'20px',borderRadius:'20px',width:'70px',display:'flex',justifyContent:'center'}}
                            ...
                            <Link to='/sell' style={{color:'white',transitionProperty:'all',transitionDuration:'300ms',animationDuration:'300ms',fontWeight:'bold',fontFamily:'cursive',backgroundColor:'#d6482b',border:'2px solid',borderColor:'#DECCBE',textDecoration:'none',fontWeight:'bold',padding:'20px',fontSize:'20px',borderRadius:'20px',width:'80px',display:'flex',justifyContent:'center'}}
